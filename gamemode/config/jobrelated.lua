...
-- Fallbacks and compatibility for unused default teams
...
-- Default group chat for players of the same team
...
-- Civil Protection table (empty by default, to be filled by your custom jobs)
